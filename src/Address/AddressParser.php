...
class AddressParser extends AbstractParser
{
    ...
    public function parseStreetAddress(string $streetAddress): array
    {
        ...
        return [
            'streetNumber' => $locationResults['streetNumber'],
            'streetName'   => $locationResults['streetName'],
            'routeType'    => $locationResults['routeType'],
            'direction'    => $locationResults['direction'],
            'unit'         => $locationResults['unit'],
        ];
    }
     ...
     */
    public function parse(?string $address = null): AddressResult
    {
